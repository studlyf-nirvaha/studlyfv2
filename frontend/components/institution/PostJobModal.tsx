                        ...
                        <div className="border-t border-slate-200 p-6 bg-white flex justify-between items-center z-10 shrink-0">
                            ...
                            <div className="flex gap-4">
                                ...
                                {step < steps.length ? (
                                    ...
                                    <button onClick={() => handleSubmit(false)} disabled={loading} className="px-8 py-3 bg-emerald-500 text-white font-bold rounded-xl hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-200 flex items-center gap-2">
